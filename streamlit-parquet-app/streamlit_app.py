...
def tab2_top3_agencias(df_raw: pd.DataFrame):
    ...
    # Estilo (quando suportado) + fallback garantido
...
def tab3_top3_precos(df_raw: pd.DataFrame):
    ...
    def _top3(gr: pd.DataFrame) -> pd.Series:
    ...
    show_table(tabela, caption="Top 3 por (Trecho, ADVP) — última pesquisa")
...
def tab4_ranking_agencias(df_raw: pd.DataFrame):
    ...
    # E o gráfico (opcional, mantém visual)
