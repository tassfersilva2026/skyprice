...
# Banner (primeira imagem encontrada na raiz do repo)
banner = None
for ext in ("*.png","*.jpg","*.jpeg","*.gif","*.webp"):
    ...
    if imgs:
        banner = imgs[0]; break
if banner:
    st.image(banner.as_posix(), use_container_width=True)
...
# =========================================================
# Filtros (logo abaixo das abas) — dd/mm/aaaa
# =========================================================
with st.container():
...
# =========================================================
# 2) Top 3 Agências (mais vitórias em 1º) — barras
# =========================================================
with tabs[1]:
